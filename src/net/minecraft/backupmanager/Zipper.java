...
public class Zipper
{
  ...
  protected static boolean addToZip(String absolutePath, String relativePath, String fileName, ZipOutputStream out) {
    ...
    MinecraftBackupManager.lastfile.setText("Zipping " + absolutePath + File.separator + fileName);
    if (file.isHidden())
      return true;
    if (file.isDirectory()) {
    ...
    try {
      ...
      while ((count = origin.read(data, 0, 2048)) != -1)
      {
    	...
    	OptionsMenu.progress.setValue((int)((currentSize / maximumSize)*100));
  ...
  public static void unzipFolder(File zipFile, File destFolder)
  {
    try
    {
      ...
      while ((entry = zis.getNextEntry()) != null)
      {
        ...
        MinecraftBackupManager.lastfile.setText("Extracting " + entry);
